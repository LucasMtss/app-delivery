                        ...
                        <div className="">
                            <div>
                                <div className="p-5 flex-1">
                                    <div className="border-b border-slate-700 max-h-[50vh] overflow-y-scroll w-full no-scrollbar">
                                        {
                                            cartItems.map(item => <Product onClick={() => handleSelectItem(item.product)} key={item.product.id} data={{...item.product, quantity: item.quantity}} />)
                                        }
                                    </div>
