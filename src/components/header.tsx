...
export function Header({title, cartQuatityItems = 0}: IHeaderProps){
    ...
    return (
        <div className="flex flex-row items-start border-b border-red-400 pb-5 mx-5">
                ...
                cartQuatityItems > 0 && (
                    <div onClick={() => navigate('/cart')}>
                        <div className="flex">
                            ...
                            <div className="flex bg-red-400 rounded-full w-6 h-6 items-center justify-center -bottom-5 z-10 -right-3.5">
